...
ASTNodePtr Parser::parseStatement() {
    ...
    // যদি/নাহলে (if-else) parsing is implemented below (parseIfStatement)
    // but intentionally not wired into parseStatement() yet — full
    // conditional branching is a Part 2 / Review 3 feature.
