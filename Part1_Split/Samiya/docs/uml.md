...
> **Part 1 snapshot:** `যতক্ষণ` (while) is implemented in every phase below
> but not yet wired into `Parser::parseStatement()` — see `docs/report.md`.
> It ships active in Part 2.
